...
from .views import BookAppointmentView, AdminAppointmentsView, AdminCreateAppointmentView, DoctorAppointmentsView, UpdateAppointmentStatusView, DeleteAppointmentView, DoctorSlotsView
